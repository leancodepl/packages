...
/// This method is needed for compatibility of Swift tests with Objective-C code.
/// In Swift, the API for setting key-value pairs on a queue is different, so Swift tests
